...
export default function NewArrivals() {
  return (
    <section className="relative w-full h-screen bg-[#0a0a09] overflow-hidden flex items-center justify-center">
      {/* === Background Filled Text === */}
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        <h1 className="font-extrabold uppercase text-[#F9E9C8] leading-none 
          text-[clamp(8rem,15vw,15rem)]">
          SUM
          <br />
          MER
          <br />
        ...
        <div className="relative">
          <img
            ...
            className="object-cover rounded-lg 
              w-[150px] h-[180px] sm:w-[250px] sm:h-[300px] lg:w-[350px] lg:h-[400px]"
          />
          <div className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-white rounded-full 
            w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 flex items-center justify-center shadow-lg">
            <span className="text-red-500 text-sm sm:text-base lg:text-lg">♥</span>
          </div>
        </div>
      </div>

      <div className="absolute top-[50%] right-[7.5%] sm:top-[50%] sm:right-[20%] rotate-[8deg] z-30">
        <div className="relative">
          <img
            ...
            className="object-cover rounded-lg 
              w-[150px] h-[180px] sm:w-[250px] sm:h-[300px] lg:w-[350px] lg:h-[400px]"
          />
          <div className="absolute -top-3 right-2 sm:-top-4 sm:right-4 bg-[#FF5733] text-white 
      ...
      <div className="absolute inset-0 z-20">
        <div
          ...
          w-[150px] h-[180px] sm:w-[250px] sm:h-[300px] lg:w-[350px] lg:h-[400px] rounded-lg"
          style={{
        ...
        />
        <div
          className="absolute top-[50%] right-[7.5%] sm:top-[50%] sm:right-[20%] rotate-[8deg] 
          w-[150px] h-[180px] sm:w-[250px] sm:h-[300px] lg:w-[350px] lg:h-[400px] rounded-lg"
          style={{
            mixBlendMode: "multiply",
            background:
      ...
      <div className="absolute top-[20%] right-[15%] sm:top-[20%] sm:right-[25%] z-40">
        <button className="bg-gradient-to-r from-yellow-400 to-orange-400 text-black font-bold 
      ...
      <div className="absolute bottom-[8%] left-[10%] sm:bottom-[10%] sm:left-[10%] z-40 max-w-[80%] sm:max-w-xs">
